      ...
      <div className="flex flex-col gap-12 sm:gap-16 md:gap-20 lg:gap-40 xl:gap-60 mt-16 sm:mt-20 md:mt-32 px-4 sm:px-6 md:px-0">
        {projects.map((proj, projectIndex) => (
          ...
          >
            ...
            <span 
              className="featured-no absolute text-[4rem] sm:text-[6rem] md:text-[8rem] lg:text-[10rem] xl:text-[12rem] font-bold bg-gradient-to-br from-secondary to-primary bg-clip-text text-transparent opacity-15 -top-12 sm:-top-16 md:-top-24 lg:-top-32 hidden md:block"
            >
              0{proj.id}
            </span>
            ...
            <div className="w-full z-10 md:w-1/2 space-y-4 sm:space-y-5 md:space-y-6">
              ...
              >
                <h3 
                  className="text-primary text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 dark:text-white"
                >
                  {proj.heading}
                </h3>
              </motion.div>
              ...
              <motion.div
                ...
                className="backdrop-blur-md bg-white/30 dark:bg-gray-900/50 p-4 sm:p-5 md:p-6 rounded-xl md:rounded-2xl border border-gray-200/50 dark:border-gray-700/50 shadow-xl"
              >
                <RichText
              ...
              >
                {proj.websiteLink && (
                  <a
                    className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 text-xs sm:text-sm font-bold text-white bg-gradient-to-r from-secondary via-primary to-secondary rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-200"
              ...
              >
                <div className="flex items-center gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-5 md:mb-6">
                  <div
                    className="h-px bg-gradient-to-r from-transparent via-secondary to-transparent w-full"
                  />
                  <span 
                ...
                className="flex flex-wrap items-center gap-2 sm:gap-2.5 md:gap-3 py-4 sm:py-5 md:py-6">
                {proj.html && (
                  <div 
